...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /home/lance/Desktop/ch2_hw/ros/ws/src/rviz_plugins)
  set(rviz_plugins_DEVEL_PREFIX /home/lance/Desktop/ch2_hw/ros/ws/devel)
  ...
  set(rviz_plugins_INSTALL_PREFIX /home/lance/Desktop/ch2_hw/ros/ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lance/Desktop/ch2_hw/ros/ws/src/rviz_plugins/${idir}'.  ${_report}")
    endif()
